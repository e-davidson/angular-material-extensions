...
const ELEMENT_DATA: PeriodicElement[] = [
  {position: 1, name: 'Hydrogen', weight: 1.0079, symbol: 'H', gas: true , date: new Date(2019, 1, 8), phone: null,moreInfo: ['hello','world' ]  },
  ...
  {position: undefined, name: 'Beryllium', weight: 9.0122, symbol: 'Be', gas: false, date: new Date(2019, 1, 4), phone: '2341185656', moreInfo: [] },
  {position: 5, name: '', weight: 10.811, symbol: 'B', gas: false, date: new Date(2019, 1, 3),  phone: '234' },
  {position: 6, name: undefined, weight: 12.0107, symbol: 'C', gas: false, date: new Date(2019, 1, 6), phone: '2346783425' , moreInfo: ['hi'] },
